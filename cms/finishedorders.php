...
?>
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="dashboard.php">Home</a> <i class="fa fa-angle-right"></i><a href="finishedorder.php">Finished Order</a></li>
</ol>
		...
		<div class="w3l-table-info ">
			...
			<?php
	            if(isset($_POST["submit"]))
	            {
	                ...
	                s.ShipperID=o.Shipper WHERE ordercode='$Order' WHERE o.Status NOT IN('Pending','Shipped') order by date");
	            ...
	            else
				{
	                ...
	                ON s.ShipperID=o.Shipper WHERE o.Status NOT IN('Pending','Shipped') order by date DESC");
					while ($ordrow = mysqli_fetch_assoc($orderquery)) {
    				    ?>
    				  <tr>
        				<td><?php echo $ordrow["ordercode"] ?></td>
        				...
        				<td><a href='#' ng-click="deliverorder(<?php echo $ordrow["OrderId"] ?>)" class="badge badge-success">Deliver</a></td>
        				<td><a href="#" ng-click="returnorder(<?php echo $ordrow["OrderId"] ?>)" class="badge badge-danger">Return</a></td>
        			  </tr>
        			  <?php
    				}
	            }
