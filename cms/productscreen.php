	...
	?>
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<div class="input-group input-icon right">
					...
					<a href="addscreen.php" class="btn btn-danger">Back</a>
				</div>
			</div>
		</div>
		...
		<?php
            if(isset($_POST["submit"]))
            {
                ...
                $imgurl = "images/productscreen/" . $ProductId . basename($_FILES["lstImage"]["name"]);

                //mysql_query("INSERT INTO blog (UserId, PostName, Post, ParentId, date) VALUES ('$userid', '$postName', '$post', '$ParentId', '$date');");
                $action = mysqli_query($con, "INSERT INTO tblproductscreen(productid, imageurl) VALUES ('$ProductId','$imgurl')");
                if($action == 1)
                {
                    $target_dir = "images/productscreen/";
