...
?>
	...
	<div class="w3l-table-info">
	  <h2>Product List</h2>
		...
		<tbody>
		<?php
		$prquery = mysqli_query($con, "SELECT ProductID, ProductName, merchantpcode, b.product CategoryName, b.product sub, QuantityPerUnit, UnitPrice, Discontinued FROM 
		tblproducts a JOIN tbl_menu b ON a.CategoryID = b.id ORDER BY ProductID DESC");
		...
		?>
		  <tr>
			...
			<td><a href='productmodify.php?id=<?php echo $prrow["ProductID"] ?>'>Edit</a></td>
		  </tr>
	    <?php
		}
		?>
